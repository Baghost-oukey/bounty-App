...
import FloatingBountyCard                      from "./components/FloatingBountyCard";
...
const BOUNTY_MARKERS: BountyMarker[] = [
    { id: "B001", lat: -6.225, lng: 106.826, emoji: "🧹", layanan: "Bersih-Bersih",     tugas: "Sapu & Pel, Kamar Mandi, Dapur",     lokasi: "Kuningan, Jaksel", jadwal: "Hari ini, 14:00", budget: 85000,  pesaing: 2, jarak: "0.8 km" },
    { id: "B002", lat: -6.218, lng: 106.802, emoji: "🚗", layanan: "Antar Jemput",      tugas: "Antar ke Bandara Soekarno-Hatta",    lokasi: "Senayan, Jakpus",  jadwal: "Besok, 06:00",    budget: 120000, pesaing: 4, jarak: "2.1 km" },
    { id: "B003", lat: -6.232, lng: 106.834, emoji: "🛍️", layanan: "Jasa Titip",        tugas: "Beli obat apotek + snack Indomaret", lokasi: "Pancoran, Jaksel", jadwal: "Hari ini, 16:30", budget: 30000,  pesaing: 1, jarak: "1.4 km" },
    { id: "B004", lat: -6.245, lng: 106.814, emoji: "💻", layanan: "Bantuan Digital",   tugas: "Desain logo brand kopi — minimalis", lokasi: "Remote",           jadwal: "Deadline 3 hari", budget: 200000, pesaing: 7, jarak: "—"    },
    { id: "B005", lat: -6.259, lng: 106.821, emoji: "📚", layanan: "Bimbingan Belajar", tugas: "Les matematika SMA — persiapan UN",  lokasi: "Kebayoran Baru",   jadwal: "Sabtu, 09:00",    budget: 150000, pesaing: 3, jarak: "3.2 km" },
];
...
export default function TakeOrderPage() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex overflow-hidden">
            ...
            >
                {mapReady && (
                    <MapView lat={DEFAULT_LAT} lng={DEFAULT_LNG} bounties={BOUNTY_MARKERS} />
                )}
