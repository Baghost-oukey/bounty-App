...
export default function FormInput() {
    ...
    const canPost = category !== "" && rawText.trim() !== "" && deadline !== "" && price !== "";
    ...
    const handleConfirmPost = async () => {
        ...
        setPosting(true);
        try {
            const catLabel = CATEGORIES.find((c) => c.id === category)?.label || "Bantuan Digital";
            const res = await createBountyTask({
                serviceName: "Layanan Bantuan Digital",
                categories: [catLabel],
                    ...
                    {step === "input" && (
                        <div className="flex flex-col flex-1 px-5 py-5 space-y-4 justify-between">
                            <div className="space-y-4">
                                ...
                                {/* Details */}
                                <div className="space-y-1.5">
                                    <label className="text-sm font-semibold text-foreground">Detail Kebutuhan</label>
                                    <textarea
                                        value={rawText}
                                        onChange={(e) => setRawText(e.target.value)}
                                        placeholder="Tulis instruksi / kebutuhan Anda... misal: butuh edit video Tiktok durasi 1 menit bertema kuliner"
                                        rows={3}
                                ...
                                {/* Deadline date */}
                                <div className="space-y-1.5">
                                    <label className="text-sm font-semibold text-foreground">Batas Waktu (Deadline)</label>
                                    <input
                                        type="date"
                                        value={deadline}
                                ...
                                {/* Budget */}
                                <div className="space-y-1.5">
                                    <label className="text-sm font-semibold text-foreground">Budget tarif (Rp)</label>
                        ...
                        <div className="flex flex-col flex-1 items-center justify-center px-5 py-8 text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-1 max-w-[240px] mx-auto leading-relaxed">
                                    Freelancer terdekat akan segera mengambil orderanmu.
                                </p>
                            </div>
