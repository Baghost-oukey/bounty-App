...
export default function FormInput() {
    ...
    const canPost = rawText.trim() !== "" && destination.trim() !== "" && price !== "";
    ...
    const handleConfirmPost = async () => {
        ...
        try {
            const res = await createBountyTask({
                serviceName: "Layanan Antar Jemput",
                categories: ["Antar Jemput"],
                date: new Date().toISOString().split("T")[0],
                time: new Date().toLocaleTimeString("id-ID", { hour: "2-digit", minute: "2-digit" }),
                description: rawText + (destination ? ` | Destinasi: ${destination}` : ""),
                price: finalPrice,
                address,
                lat,
                lng,
                        ...
                        <div className="flex flex-col flex-1 px-5 py-5 space-y-4 justify-between">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-sm font-semibold text-foreground">Lokasi Tujuan / Antar</label>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Misal: antar saya ke Bandara Soetta terminal 3, bawa barang koper besar"
                                        rows={3}
                            ...
                            <div className="bg-muted/40 border border-border/40 rounded-2xl px-4 py-4 w-full space-y-2.5 text-left text-xs">
                                ...
                                {destination && (
                                    <div className="flex justify-between gap-2">
                                        ...
                                        <span className="font-semibold text-foreground text-right leading-snug max-w-[55%] truncate">{destination}</span>
                                    </div>
                                )}
